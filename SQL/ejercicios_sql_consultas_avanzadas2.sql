...
El día de hoy vamos a realizar ejercicios en los que practicaremos sentencias SQL usando el operador GROUP BY, 
que nos ayudará a agrupar o seleccionar los resultados según los valores de algunos de los atributos de la tabla, y 
HAVING y CASE para añadir condiciones a la ejecución de ciertas partes de las consultas de manera similar a como hacemos con 
WHERE (aunque con diferencias).*/

-- Ejercicios
-- 1. Relación entre número de pedidos y máxima carga:
-- Desde logística nos piden el número de pedidos y la máxima cantidad de carga de entre los mismos (freight) que han 
-- sido enviados por cada empleado (mostrando el ID de empleado en cada caso).--
